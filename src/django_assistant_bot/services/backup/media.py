...
from django_assistant_bot.services.backup.exceptions import MediaBackupError
from django_assistant_bot.services.backup.models import MediaBackupResult


class MediaCollector:
    """
    Scans media files without loading their contents
    into memory.
    """
    ...
    def collect(
        ...
        """
        Inspect a media directory and collect file statistics.
        """
    ...
    def iter_files(
        ...
        """
        Yield all files contained in the media directory.
        """
