        ...
        buttons.append(
            [
                InlineKeyboardButton(
                    ...
                    callback_data=f"project:view:{project.id}",
                ),
            ]
        )
...
def project_details_keyboard(
    ...
    toggle_button = (
        InlineKeyboardButton(
            text="🔴 غیرفعال کردن",
            callback_data=f"project:disable:{project_id}",
        )
        if enabled
        else InlineKeyboardButton(
            text="🟢 فعال کردن",
            callback_data=f"project:enable:{project_id}",
        )
    )
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="💾 Backup Now",
                    callback_data=f"project:backup:{project_id}",
                ),
            ],
            [
                toggle_button,
